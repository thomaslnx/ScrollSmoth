...
const ScrollSmoth = (() => {
   ...
   * @param  {Window|HTMLElement|globalThis} container
   * @return {number}
   */
  ...
  /**
   * ScrollSmoth Constructor
   * @param {object} options Options
   * @param {object} easeFunctions Custom ease functions
   */
  function ScrollSmoth(options = {}, easeFunctions = {}) {
   ...
   */
  ScrollSmoth.prototype.registerTrigger = function(dom, callback) {
    if (!dom) {
      return;
    }
   ...
   */
  ScrollSmoth.prototype.move = function(target, options = {}) {
    if (target !== 0 && !target) {
      return;
    }
   ...
   */
  ScrollSmoth.prototype.addEaseFunction = function(name, fn) {
...
if (typeof module !== 'undefined') {
  module.exports = ScrollSmoth;
} else {
  window.ScrollSmoth = ScrollSmoth;
}
